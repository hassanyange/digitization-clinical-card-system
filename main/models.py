...
class ChildWeight(models.Model):
    ...
    month_27 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    month_30 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    month_33 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    month_36 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    month_39 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    month_42 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    month_45 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    month_48 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    month_51 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    month_54 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
    month_57 = models.DecimalField(max_digits=6, decimal_places=2, blank=True, null=True)
